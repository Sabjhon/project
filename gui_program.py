...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # Connect the comboBox signal to update_active_canvas slot
        self.comboBox.addItems(get_parameter_list())
    ...
    def update_widgets(self, value):
        ...
        for i in range(value):
            ...
            mpl_canvas = MplCanvas(parent=self.verticalLayoutWidget)
    ...
    def update_active_canvas(self):
        ...
        for i, mpl_canvas in enumerate(self.mpl_canvases):
            mpl_canvas.setVisible(i == selected_index or self.comboBox.currentText() == "Dynamatic")
        
        # Update the canvas to the selected one
        self.canvas = self.mpl_canvases[selected_index]
